...
def kmeans_plusplus(
    ...
    """
    # Luôn đưa random_state qua hàm check_random_state để biến số nguyên thành object
    from sklearn.utils import check_random_state # Đảm bảo đã import cái này
...
def sort_cluster_by_distance(
    X, centroids, clusters, device="cpu", dtype=torch.float32, verbose=False,
):
    """
